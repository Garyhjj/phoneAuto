...
//     var point = findColor(img, "#575363", {
//         region: [150, 1300, 800, 300],
//         threshold: 4
//     });
//    if(point){
//        toast("找到啦:" + point.x + point.y);
//     //    var a = zdd0(img, point.x);
//     //    console.log(colors.toString(qs(img,852, 1123)))
//     //    toast(colors.red(-204626))
//     //    toast(abs(-204626, qs(img,852, 1123)))
//     //    toast(a + 'hh')
//    }else{
//        toast("没找到");
//    }
...
function zdd0(tp, tmp) { //找下个位置图块的顶点位置
    ...
    for (var y0 = 700; y0 < 1400; y0 += 10) { //粗略扫描,y起始和y结尾,每行扫描完如果没扫到顶点往下进十继续扫
...
setInterval(() => { /*操作ui*/
    ...
    function zrw(a) {
        var pos = findColor(a, "#575363", { //在图片a里找这个颜色
            region: [150, 1300, 800, 300], //屏幕区域范围
            threshold: 4 //4线程找色
        });
